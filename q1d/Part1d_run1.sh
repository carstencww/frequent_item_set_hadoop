...
-file $PWD/part1d_map1.py -mapper part1d_map1.py \
-file $PWD/part1d_red1.py -reducer part1d_red1.py \
-input $IN_FILE \
-output $OUT_FILE
...
-D mapred.reduce.tasks=12 \
-file $PWD/supp.txt \
-file $PWD/part1d_map2.py -mapper part1d_map2.py \
-file $PWD/part1d_red2.py -reducer part1d_red2.py \
-input $IN_FILE \
-output $OUT_FILE
